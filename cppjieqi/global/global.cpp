...
namespace board{
	...
	int aiboard1 = register_func("AIBoard1", [](const char another_state[], bool turn, int round, const unsigned char di[5][2][123], short score, std::unordered_map<std::string, bool>* hist)\
 -> Thinker * {return new AIBoard1(another_state, turn, round, di, score, hist);});
