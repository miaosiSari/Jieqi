...
void board::Board::_initialize_dir(){
	...
	_dir['N'][0] = NORTH + NORTH + EAST; //N+N+E, E+N+E, E+S+E, S+S+E, S+S+W, W+S+W, W+N+W, N+N+W
	_dir['N'][1] = EAST + NORTH + EAST;
	_dir['N'][2] = EAST + SOUTH + EAST;
	_dir['N'][3] = SOUTH + SOUTH + EAST;
	_dir['N'][4] = SOUTH + SOUTH + WEST;
	_dir['N'][5] = WEST + SOUTH + WEST;
	_dir['N'][6] = WEST + NORTH + WEST;
	_dir['N'][7] = NORTH + NORTH + WEST;

	_dir['E'][0] = NORTH + NORTH + EAST; //N+N+E, E+N+E, E+S+E, S+S+E, S+S+W, W+S+W, W+N+W, N+N+W
	_dir['E'][1] = EAST + NORTH + EAST;
	_dir['E'][2] = WEST + NORTH + WEST;
	_dir['E'][3] = NORTH + NORTH + WEST;
	
	_dir['B'][0] = 2 * NORTH + 2 * EAST;//2 * N + 2 * E, 2 * S + 2 * E, 2 * N + 2 * W, 2 * S + 2 * W
	_dir['B'][1] = 2 * SOUTH + 2 * EAST;
	_dir['B'][2] = 2 * NORTH + 2 * WEST;
	_dir['B'][3] = 2 * SOUTH + 2 * WEST;
	
	_dir['F'][0] = 2 * NORTH + 2 * EAST;
	_dir['F'][1] = 2 * NORTH + 2 * WEST;
