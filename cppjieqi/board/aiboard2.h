...
typedef short(*SCORE2)(board::AIBoard2* bp, const char* state_pointer, unsigned char src, unsigned char dst);
typedef void(*KONGTOUPAO_SCORE2)(board::AIBoard2* bp, short* kongtoupao_score, short* kongtoupao_score_opponent);
typedef std::string(*THINKER2)(board::AIBoard2* bp);
...
private:
    ...
    SCORE2 _score_func = NULL;
    KONGTOUPAO_SCORE2 _kongtoupao_score_func = NULL;
    THINKER2 _thinker_func = NULL;
