...
class Position(namedtuple('Position', 'board score turn')):
    ...
    def value(self, move):
        ...
        if p == 'H' and ((i == 164 and j == 52 and self.board[51] in 'dr') or (i == 170 and j == 58 and self.board[59] in 'dr')):  # TODO: 使用更智能的方式处理博子
            boolean = False
            if (self.board[151] == 'N' and self.board[135] == 'p') or (self.board[159] == 'N' and self.board[143] == 'p'):  # 兵顶马
                boolean = True
            if not boolean:
                ...
                if self.che == self.che_opponent:
                    ...
                    if (i == 164 and self.board[148] in 'pr') or (i == 170 and self.board[154] in 'pr'):
                        ...
                        if (i == 164 or self.board[196] in 'DEFGHI') or (i == 170 and self.board[202] in 'DEFGHI'):
        ...
        if p in 'RNBAKCP':
            ...
            if p == 'D':
               ...
               minus = 20+40*(di[not self.turn][key]+self.che_opponent)
        ...
        if q.isupper():
            ...
            if q in 'RNBAKCP':
                ...
                if q == 'D':
                    ...
                    addition = 20 + 40*(di[self.turn][key]+self.che)
